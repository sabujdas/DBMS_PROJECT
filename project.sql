...
CREATE TABLE `campaign` (
  ...
  KEY `campaign_FK_1` (`CandidateID`),
  KEY `campaign_FK_2` (`PartyID`),
  CONSTRAINT `campaign_FK_1` FOREIGN KEY (`CandidateID`) REFERENCES `candidates` (`CandidateID`) ON UPDATE CASCADE,
  CONSTRAINT `campaign_FK_2` FOREIGN KEY (`PartyID`) REFERENCES `candidates` (`PartyID`) ON UPDATE CASCADE
...
CREATE TABLE `candidates` (
  ...
  KEY `candidates_FK_1` (`PartyID`),
  KEY `candidates_FK_2` (`CategoryID`),
...
CREATE TABLE `candidates_uses_media` (
  ...
  KEY `candidates_uses_media_FK_1` (`CandidateID`),
  KEY `candidates_uses_media_FK_2` (`MediaID`),
...
CREATE TABLE `election` (
  ...
  KEY `election_FK_1` (`CategoryID`),
  CONSTRAINT `election_FK_1` FOREIGN KEY (`CategoryID`) REFERENCES `category` (`CategoryID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `election_has_candidates` (
  `ElectionID` varchar(45) NOT NULL,
  `CandidateID` int NOT NULL,
  KEY `election_has_candidates_FK_1` (`ElectionID`),
  KEY `election_has_candidates_FK_2` (`CandidateID`),
  CONSTRAINT `election_has_candidates_FK_1` FOREIGN KEY (`ElectionID`) REFERENCES `election` (`ElectionID`),
  CONSTRAINT `election_has_candidates_FK_2` FOREIGN KEY (`CandidateID`) REFERENCES `candidates` (`CandidateID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `precinct` (
  ...
  KEY `precinct_FK_1` (`CityID`),
  KEY `precinct_FK_2` (`StateID`),
...
INSERT INTO `precinct` VALUES (211,'Bronx',21,2),(212,'Brooklyn',21,2),(213,'Manhattan',21,2),(221,'Alden',22,2),(222,'Buffalo',22,2),(223,'Williamsville',22,2),(231,'Brighton',23,2),(232,'Gates',23,2),(233,'Hamlin',23,2),(311,'Bloomfield',31,3),(312,'Caldwell',31,3),(313,'Irvington',31,3),(321,'Hamilton',32,3),(322,'Lawrence',32,3),(323,'Pennington',32,3),(331,'Atlantic',33,3),(332,'Burlington',33,3),(333,'Cumberland',33,3),(411,'Arcadia',41,4),(412,'Long Beach',41,4),(413,'Los Angeles',41,4),(421,'Avenal',42,4),(422,'Hanford',42,4),(423,'Lemoore',42,4),(431,'Tustin',43,4),(432,'Stanton',43,4),(433,'Irvine',43,4);
...
CREATE TABLE `vote` (
  ...
  KEY `vote_FK_1` (`ElectionID`),
  KEY `vote_FK_2` (`PartyID`),
  KEY `vote_FK_3` (`BallotID`),
  KEY `vote_FK_4` (`PrecinctID`),
  CONSTRAINT `vote_FK_1` FOREIGN KEY (`ElectionID`) REFERENCES `election` (`ElectionID`),
  CONSTRAINT `vote_FK_2` FOREIGN KEY (`PartyID`) REFERENCES `party` (`PartyID`),
  CONSTRAINT `vote_FK_3` FOREIGN KEY (`BallotID`) REFERENCES `voter_info` (`BallotID`),
  CONSTRAINT `vote_FK_4` FOREIGN KEY (`PrecinctID`) REFERENCES `precinct` (`PrecinctID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `voter_info` (
  ...
  `PrecinctID` int DEFAULT NULL,
  `EmailID` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`BallotID`),
  UNIQUE KEY `SSN` (`SSN`),
  KEY `voter_info_FK_1` (`PrecinctID`),
...
-- Dump completed on 2023-11-14 14:51:03
